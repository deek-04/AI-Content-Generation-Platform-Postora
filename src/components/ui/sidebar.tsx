...
export function CustomSidebar({
  ...
  useEffect(() => {
    ...
    // Add class to body for collapsed sidebar
    if (!expanded) {
  ...
  return (
    <aside
      className={cn(
        "group relative flex h-svh flex-col overflow-y-hidden border-r bg-background",
        expanded ? "w-60" : "w-16",
    ...
    >
      ...
      {collapsible && (
        <div className="flex h-[52px] items-center justify-end px-2">
          <Button
            variant="ghost"
            size="icon"
            className="h-9 w-9"
